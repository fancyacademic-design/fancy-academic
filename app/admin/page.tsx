...
export default function AdminPage() {
  ...
  // ✅ الأزرار الجديدة (تم حذف رسائل الدعم والإعدادات وسجل المعلمين)
  const tabs = [
  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.tabsContainer}>
        ...
        {/* ✅ الأزرار - تم حذف رسائل الدعم والإعدادات وسجل المعلمين */}
...
// ============================================
// StudentsTab المعدل مع فلترة حسب نوع الحساب
// ============================================
function StudentsTab() {
  ...
  const [userRole, setUserRole] = useState('all') // ✅ فلترة حسب الدور
  ...
  try {
    ...
    querySnapshot.forEach((doc) => {
      ...
      usersList.push({
        ...
        role: data.role || 'student', // ✅ إضافة الدور
  ...
  // ✅ فلترة المستخدمين حسب الحالة والدور
                ...
                {filteredUsers.map(user => (
                  <tr key={user.id} style={styles.tr}>
                    ...
                    {activeView === 'active' && (
                      <td style={styles.td}>
                        <span style={{
                          background: user.lastLogin ? '#d1fae5' : '#fee2e2',
                          color: user.lastLogin ? '#065f46' : '#991b1b',
                          padding: '6px 12px',
                          borderRadius: '20px',
