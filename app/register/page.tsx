...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (userType === 'parent') {
        ...
        userData.children = children.filter(c => c.name.trim() !== '');
        ...
        userData.parentPhone = parentPhoneCleaned ? countryCode + parentPhoneCleaned : '';
        userData.grade = (form.querySelector('[name="grade"]') as HTMLSelectElement)?.value || '';
        userData.parentName = parentNameInput?.value || '';
      } else if (userType === 'teacher') {
        userData.subject = (form.querySelector('[name="subject"]') as HTMLSelectElement)?.value || '';
        userData.grade = (form.querySelector('[name="grade"]') as HTMLSelectElement)?.value || '';
      }
  ...
  return (
    <div style={styles.container}>
          ...
          <div style={styles.imageWrapper}>
            ...
            {!isMobile && (
              <div style={styles.rightPanelLinks}>
                <button type="button" style={{...styles.rightLink, ...styles.greenButton}}>
        ...
        <div style={isMobile ? styles.leftPanelMobile : styles.leftPanel}>
          <div style={styles.formCard}>
            ...
            <form onSubmit={handleSubmit} style={styles.form}>
              ...
              {/* رقم الهاتف مع كود الدولة - تصميم جديد */}
              <div style={styles.inputGroup}>
              ...
              {userType === 'student' && (
                <>
                  ...
                  <div style={styles.inputGroup}>
                    <label style={styles.label}><span style={styles.labelIcon}>👨‍👦</span>رقم ولي الأمر</label>
                    <div style={styles.phoneWrapper}>
                      <div style={styles.phoneInputContainer}>
                        <select
                          value={countryCode}
                  ...
                  <div style={styles.inputGroup}>
                    ...
                    <input type="text" name="parentName" placeholder="اسم ولي الأمر (اختياري)" style={styles.input} />
                  </div>
                </>
              )}
              ...
              {userType === 'parent' && (
                <>
                  ...
                  <div style={styles.childrenSection}>
                    <label style={styles.label}><span style={styles.labelIcon}>👦</span>الأبناء</label>
              ...
              {userType === 'teacher' && (
                <>
                  <div style={styles.inputGroup}>
                    <label style={styles.label}><span style={styles.labelIcon}>📚</span>المادة</label>
                    <select name="subject" required style={styles.select}>
                  ...
                  <div style={styles.inputGroup}>
                    <label style={styles.label}><span style={styles.labelIcon}>📚</span>المرحلة</label>
                    <select name="grade" required style={styles.select}>
      ...
      {/* الرابطين في الموبايل تحت */}
      {isMobile && (
        <div style={styles.mobileLinks}>
          <button type="button" style={{...styles.mobileLink, ...styles.greenButtonMobile}}>
            <span style={styles.linkIcon}>💬</span>
            <span>تواصل مع الدعم</span>
          </button>
...
const styles: any = {
  ...
  hint: { display: 'block', fontSize: '12px', color: 'rgba(255,255,255,0.4)', marginTop: '6px' },
